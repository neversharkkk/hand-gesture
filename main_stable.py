    ...
    def start(self):
        try:
            ...
            if self.cap.isOpened():
                ...
                Logger.info("SimpleCamera: Camera started")
                return True
        except Exception as e:
            Logger.error(f"SimpleCamera: Error - {e}")
            import traceback
    ...
    def _capture_loop(self):
        ...
        while self.running:
            try:
                ...
                Logger.error(f"SimpleCamera: Capture error - {e}")
            time.sleep(0.02)
...
class SimpleHandDetector:
    ...
    def initialize(self):
        try:
            ...
            Logger.error(f"SimpleHandDetector: Init error - {e}")
    ...
    def detect(self, frame):
        ...
        try:
            ...
            Logger.error(f"SimpleHandDetector: Detect error - {e}")
            return None, None, 0
    ...
    def recognize_gesture(self, frame, contour):
        ...
        try:
            ...
            Logger.error(f"SimpleHandDetector: Recognize error - {e}")
            return 'Unknown', 0
...
def create_simple_ascii(image, contour):
    ...
    try:
        ...
        Logger.error(f"create_simple_ascii: Error - {e}")
        return image


class StableHandGestureApp(App):
