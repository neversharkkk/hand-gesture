...
class HandGestureWidget(BoxLayout):
    ...
    def _build_ui(self):
        ...
        info_inner = BoxLayout(orientation='vertical', spacing=2)
        ...
        self.mode_panel = BoxLayout(size_hint=(1, 0.06), spacing=3)
        ...
        for text, mode in modes:
            btn = ModeButton(text=text, mode=mode)
            if mode == MODE_CAMERA:
                btn.state = 'down'
        ...
        control_panel = BoxLayout(size_hint=(1, 0.08), spacing=5)
        ...
        slider_panel = BoxLayout(size_hint=(1, 0.06), spacing=5)
        
        slider_panel.add_widget(Label(text='Sensitivity:', size_hint_x=0.3, font_size='12sp'))
        ...
        slider_panel.add_widget(self.sensitivity_slider)
        
        self.add_widget(slider_panel)
    ...
    def stop_camera(self):
        ...
        Logger.info('HandGestureWidget: Camera stopped')
    ...
    def update(self, dt):
        ...
        if self.camera_active and self.current_mode == MODE_GESTURE:
            self._simulate_gesture_detection()
    
    def _simulate_gesture_detection(self):
        import random
        if random.random() < 0.05:
            gestures = ['Open Hand', 'Fist', 'Pointing', 'Victory', 'Thumbs Up', 'None']
